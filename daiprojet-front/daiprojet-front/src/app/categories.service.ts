...
export class CategoriesService {
  ...
  addCategories(categories: Categories): Observable<Object> {
    return this.httpClient.post(`${this.baseUrl}`,categories);
  }

  updateCategories(id: number, categories: Categories): Observable<Object> {
    return this.httpClient.put(`${this.baseUrl}/${id}`, categories);
  }
}
