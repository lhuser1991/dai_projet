...
export class UniversService {
  ...
  addUnivers(univers: Univers): Observable<Object> {
    return this.httpClient.post(`${this.baseUrl}`,univers);
  }

  updateUnivers(id: number, univers: Univers): Observable<Object> {
    return this.httpClient.put(`${this.baseUrl}/${id}`, univers);
  }
}
